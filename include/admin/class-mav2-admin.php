...
final class MAV2_Admin
{
    ...
    public function site_enqueue_scripts($hook)
    {
        ...
        if (is_page('short-code-test') || is_page('my-account')) {
            ...
            wp_enqueue_style('mav2-site-css', MAV2_ASSETS_URL . 'css/mav2.site.css', [], MAV2_VERSION);

            wp_enqueue_script('mav2-axios', MAV2_ASSETS_URL . 'vendors/axios.js', [], MAV2_VERSION, true);
            wp_enqueue_script('mav2-site-js', MAV2_ASSETS_URL . 'js/mav2.site.js', ['jquery', 'mav2-axios'], MAV2_VERSION, true);
