          ...
          <tr style="width:100%">
            <td>
              <div style="padding:16px 24px 16px 24px;text-align:center">
                <a
                  href="https://www.japanrailclub.com"
              ...
              <h2
                style="color:#001a43;font-weight:bold;text-align:center;margin:0;font-size:24px;padding:16px 24px 0px 24px"
              >
              ...
              <div style="font-weight:normal;padding:16px 24px 16px 24px">
                Thank you for staying with us! Your exclusive discount has been
                successfully applied to your subscription.
              </div>
              <div style="font-size:16px;padding:16px 24px 0px 24px">
                There's nothing more you need to do — simply sit back, relax,
                and look forward to your next
                <strong>Omiyage Snack Box,</strong> filled with authentic treats
                from Japan.
              </div>
              ...
              <div style="font-size:16px;padding:0px 24px 0px 24px">
                <p
                  style="background-color:#fefaf1;padding:16px;margin-top:24px;border-radius:8px;text-align:left"
                >
              ...
              <div style="font-weight:normal;padding:16px 24px 16px 24px">
                We truly appreciate your continued support and look forward to
                sharing more of Japan’s finest flavours with you.
              </div>
              <div style="font-size:16px;padding:0px 24px 0px 24px">
                <p>
                  Questions? Reach us anytime at
                  <a href="mailto:info@japanrailclub.com" target="_blank"
              ...
              <div
                style="font-weight:bold;text-align:center;padding:16px 24px 16px 24px"
              >
