...
<head>
  ...
  <title>Address Updated EN</title>
...
<body data-no-translation style="margin:0;padding:0;word-spacing:normal;background-color:#f4f4f4;">
  ...
  <tr>
    <td style="padding-top:12px;padding-right:24px;padding-bottom:12px;padding-left:24px;">
      <p style="margin:0;padding:0;font-family:Arial, Helvetica, sans-serif;font-size:24px;font-weight:bold;font-style:normal;color:#001A43;text-align:center;line-height:1.6;">Address Updated!</p>
    </td>
  </tr>
  <tr>
    <td style="padding-top:12px;padding-right:24px;padding-bottom:12px;padding-left:24px;">
      <p style="margin:0;padding:0;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:normal;font-style:normal;color:#333333;text-align:left;line-height:1.6;">Thank you for updating your delivery address. Please note that the updated address will take effect from your next delivery onwards.</p>
    </td>
  </tr>
  <tr>
    <td style="padding-top:12px;padding-right:24px;padding-bottom:12px;padding-left:24px;">
      <p style="margin:0;padding:0;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:normal;font-style:normal;color:#333333;text-align:left;line-height:1.6;">For the current shipment, we kindly recommend reaching out to your local post office to inform them of the address update for a smoother delivery.</p>
    </td>
  </tr>
  <tr>
    <td style="padding-top:12px;padding-right:24px;padding-bottom:12px;padding-left:24px;text-align:left;color:#333333;font-size:14px;font-weight:normal;font-style:normal;font-family:Arial, Helvetica, sans-serif;">
       <p>If you need further assistance, you can reach out to us at
                                <a href="mailto:info@japanrailclub.com"
                                    style="color: #236fa1; text-decoration: underline;">info@japanrailclub.com</a>.
                            </p>
    </td>
  </tr>
  <tr>
