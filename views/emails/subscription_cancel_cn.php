...
<body data-no-translation style="margin:0;padding:0;word-spacing:normal;background-color:#f4f4f4;">
  ...
  <tr>
    <td align="center" style="padding-top:10px;padding-right:0px;padding-bottom:10px;padding-left:0px;">
      <a href="https://www.japanrailclub.com/zh/?utm_source=email&utm_medium=email&utm_campaign=automated" target="_blank" style="text-decoration:none;"><img src="https://lofpoghg4ckxgpnx.public.blob.vercel-storage.com/projects/27162abc-0ca7-4e04-8db5-678b4be25227/080f10b8-ee8b-43d3-b805-80ed0d3b2db0.svg" alt="Japan Rail Logo" width="120" style="display:block;border:0;outline:none;text-decoration:none;max-width:100%;height:auto;" /></a>
    </td>
  </tr>
  <tr>
    <td style="padding-top:12px;padding-right:24px;padding-bottom:12px;padding-left:24px;">
      <p style="margin:0;padding:0;font-family:Arial, Helvetica, sans-serif;font-size:24px;font-weight:bold;font-style:normal;color:#001A43;text-align:center;line-height:1.6;">您的 JAPAN RAIL CLUB 訂閱已被取消。</p>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="padding-top:12px;padding-right:24px;padding-bottom:12px;padding-left:24px;">
      <p style="margin:0;padding:0;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:normal;font-style:normal;color:#333333;text-align:center;line-height:1.6;">此邮件旨在通知您，您的 JAPAN RAIL CLUB 订阅已正式取消。取消详情如下：</p>
    </td>
  </tr>
  <tr>
    <td style="padding-top:12px;padding-right:24px;padding-bottom:12px;padding-left:24px;text-align:left;color:#333333;font-size:14px;font-weight:normal;font-style:normal;font-family:Arial, Helvetica, sans-serif;">
      <table style="width: 100%; max-width: 600px; border-collapse: separate; border-spacing: 0; background-color: #f8f9fa; border-radius: 12px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #333333; margin: 20px 0;">
    <tbody>
        <tr>
            <td style="padding: 24px 0 12px 24px; font-weight: bold; font-size: 14px; width: 150px; vertical-align: top;">
                订阅方案
            </td>
            <td style="padding: 24px 24px 12px 0; text-align: right; font-size: 14px; color: #444444;">
                <?=$plan;?>
            </td>
        </tr>
        <tr>
            <td style="padding: 12px 0 24px 24px; font-weight: bold; font-size: 14px; vertical-align: top;">
                取消日期
            </td>
            <td style="padding: 12px 24px 24px 0; text-align: right; font-size: 14px; color: #444444;">
                 <?=$cancelled_date;?> SGT
            </td>
        </tr>
    </tbody>
  ...
  <tr>
    <td style="padding-top:12px;padding-right:24px;padding-bottom:12px;padding-left:24px;">
      <p style="margin:0;padding:0;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:normal;font-style:normal;color:#333333;text-align:center;line-height:1.6;">如果您预付的订阅中仍有剩余的月度礼盒，您仍将收到这些礼盒。如果存在任何未结清的款项，我们将立即进行扣款。</p>
    </td>
  </tr>
  <tr>
