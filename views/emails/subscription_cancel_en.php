...
<body data-no-translation style="margin:0;padding:0;word-spacing:normal;background-color:#f4f4f4;">
  ...
  <tr>
    <td style="padding-top:12px;padding-right:24px;padding-bottom:12px;padding-left:24px;">
      <p style="margin:0;padding:0;font-family:Arial, Helvetica, sans-serif;font-size:24px;font-weight:bold;font-style:normal;color:#001A43;text-align:center;line-height:1.6;">Your JAPAN RAIL CLUB Subscription has been cancelled.</p>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="padding-top:12px;padding-right:24px;padding-bottom:12px;padding-left:24px;">
      <p style="margin:0;padding:0;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:normal;font-style:normal;color:#333333;text-align:center;line-height:1.6;">This is to inform you that your subscription to JAPAN RAIL CLUB has been effectively canceled. Details of the cancelation are as follows:</p>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="padding-top:12px;padding-right:24px;padding-bottom:12px;padding-left:24px;">
      <p style="margin:0;padding:0;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:normal;font-style:normal;color:#333333;text-align:center;line-height:1.6;">You will still be receiving the remaining monthly boxes (if any) in your prepaid subscription. If there are any outstanding payments, we will collect them immediately.</p>
    </td>
  </tr>
  <tr>
...
<a href="mailto:info@japanrailclub.com">support team.</a>
    </td>
  </tr>
  <tr>
    <td style="padding-top:12px;padding-right:20px;padding-bottom:12px;padding-left:20px;">
